                                        ...
                                        <tbody>
                                            @foreach ($companies as $company)
                                                <tr class="border-b dark:border-gray-700">
                                                    ...
                                                    <td class="px-4 py-3 text-center">
                                                        @if ($company->image)
                                                            <div class="flex flex-col justify-center items-center">
                                                                ...
                                                                <img src="{{ asset('storage/companies_images/' . $company->image) }}"
                                                    ...
                                                    <td class="px-4 py-3 text-center text-white ">{{ $company->name }}
                                                    </td>

                                                    <!-- Actions -->
                                                    <td
                                                        class="px-4 py-3  text-center flex flex-row flex-wrap justify-center  ">
                                                        <!-- Buttons  -->
                                                        <span
                                                            ...
                                                            <form
                                                                action="{{ route('admin.companies.delete', $company->id) }}"
                                                                method="post"
